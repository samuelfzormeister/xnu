...
lck_grp_t *sk_lock_group = NULL;
lck_grp_attr_t *sk_group_attr = NULL;
lck_attr_t *sk_lock_attr = NULL;
lck_mtx_t sk_lock;
...
skywalk_init(void)
{
	...
	sk_lock_attr = lck_attr_alloc_init();
	sk_group_attr = lck_grp_attr_alloc_init();
	sk_lock_group = lck_grp_alloc_init("sk_lock", sk_group_attr);
	lck_mtx_init(&sk_lock, sk_lock_group, sk_lock_attr);
