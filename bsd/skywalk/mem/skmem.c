...
lck_attr_t *skmem_lock_attr = NULL;
lck_grp_attr_t *skmem_lock_grp_attr = NULL;
lck_grp_t *skmem_lock_group = NULL;
...
skmem_init(void)
{
	...
	skmem_lock_attr = lck_attr_alloc_init();
	ASSERT(skmem_lock_attr != 0);
	skmem_lock_grp_attr = lck_grp_attr_alloc_init();
	ASSERT(skmem_lock_grp_attr != 0);
	skmem_lock_grp = lck_grp_alloc_init("skmem", skmem_lock_grp_attr);
	ASSERT(skmem_lock_grp != 0);
